  ...
  return (
    <header className="border-[1px] bg-white rounded-lg max-h-[60px] min-h-[60px] flex justify-between items-center gap-1 p-[15px] shadow-sm">
      ...
      <div className="flex justify-end items-center gap-[15px]">
        ...
        <Link to="/favourite" data-discover="true" className="flex cursor-pointer group text-[22px] relative justify-center items-center gap-[5px]">
          <Heart size={20} />
        ...
        <Link to="/basket" data-discover="true" className="flex cursor-pointer group justify-center items-center gap-[7px]">
        ...
        <div className="flex justify-center items-center gap-1">
          <button className="w-[90px] h-[34px] cursor-pointer flex flex-col items-center justify-center bg-gradient-to-r from-blue-700 to-indigo-500 text-white font-medium py-1.5 px-3 rounded-full hover:from-indigo-500 hover:to-blue-700 transition-all duration-300 shadow-md">
            <span className="px-[10px]">Login</span>
          </button>
        </div>
