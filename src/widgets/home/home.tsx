      ...
      {isLoading ? (
        ...
        <div className="p-[7px] h-full w-full relative  overflow-hidden max-w-[2000px] mx-auto flex justify-center items-center flex-col gap-3">
          <div className="flex relative z-[1] flex-col justify-center items-center gap-3">
            <motion.h2 initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, type: "spring", stiffness: 100, damping: 13 }}
            ...
            <motion.p initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, type: "spring", stiffness: 100, damping: 13 }}
